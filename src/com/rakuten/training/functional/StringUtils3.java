...
//		System.out.println(shortWords2);
		...
		List<String> excitingWords = StringUtils3.transformedList(words, s -> s + "!");
		System.out.println(excitingWords);
		List<String> eyeWords = StringUtils3.transformedList(words, s -> s.replace("i", "eye"));
		System.out.println(eyeWords);
		List<String> upperCaseWords = StringUtils3.transformedList(words, String::toUpperCase);
